...
// PropertyTransfer smart contract to show the property transfer transactions
...
// This functions helps to transfer the ownership of the property
...
func (pc *PropertyTransferSmartContract) ChangePropertyValue(ctx contractapi.TransactionContextInterface, id string, newValue int) error {
	property, err := pc.QueryPropertyById(ctx, id)
	if err != nil {
		return err
	}
